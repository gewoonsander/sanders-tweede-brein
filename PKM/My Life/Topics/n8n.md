...
n8n is een open-source automatiseringstool waarmee je workflows bouwt die apps en diensten aan elkaar koppelen — vergelijkbaar met Zapier maar krachtiger en meer in eigen beheer. Sander heeft een Cloud Start jaarabonnement (zie [[abonnementen]]).

## Status

Actief als experiment. Nog niet intensief in gebruik, maar de intentie is om het actiever te gaan inzetten. Opzeggen vóór 8 oktober 2026 als het toch niks wordt.
...
- Doelstelling dartscoaching: [[dartscoaching]] (indien aanwezig)
