...
- **2026-06-22** — Kennismakingsgesprek (maandagavond ~20:00) via Fireflies-opname. Emiel schets zijn communicatievisie voor RDB na de bestuurscrisis: simpele openbare WordPress-site zonder login walls, alles wat op Facebook staat ook op de website. Spreekt schrik uit over vrijwilligerstekort en hoe slecht communicatie naar leden zonder Facebook werkt. Brengt sponsoring-idee ter sprake (ZZP'ers/kleine bedrijfjes onder leden, LACO-bijdrage deels sponsoren), groeiambitie naar ~1200 leden. Bespreken waarom spelersmarktplaats-project (oorspronkelijk idee van Nick) stil liep — Emiel had hier drie jaar eerder onderzoek/voorwerk voor gedaan, maar vond het niet eerlijk om te factureren omdat hij zelf nog in leerfase zat (AI net op) en niet voldoende had opgeleverd. **Dit budget is dus nooit aangesproken — financieel relevant voor RDB-begroting.** Technische afspraken: Emiel wil tweede WordPress-instantie offline opzetten, Sander blijft hosten en factureren. Open vraag: is Nick's Canva-registratie RDB-licentie of persoonlijk? Sander zal woensdag 25 juni inloggegevens WPMU Dev + Google Workspace sturen naar e.theloosen@calvi-insight.com. Maandelijks sparren afgesproken.
