...
This SOP keeps that view fresh. Every task-touching SOP calls it as the last step. Hermes also calls it at session boot if the index mtime is older than the newest task file's mtime.
