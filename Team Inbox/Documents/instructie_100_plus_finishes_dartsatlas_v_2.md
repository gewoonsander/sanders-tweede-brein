...
```text
Bij vragen over 100+ finishes in één specifieke Pub Qualifier mag je nooit varen op seizoensstatistieken, matchheaders of gewone 100+ scores. Gebruik alleen het specifieke toernooi en open vervolgens alle gespeelde wedstrijden. Controleer per match alle legs, bepaal wie de leg won, neem alleen de winnende spelersreeks, tel die exact op tot 501 en noteer alleen de laatste score als finish wanneer die 101 of hoger is. Behandel elke opvallende 100+-score eerst als gewone score totdat bewezen is dat het de slotscore van de legwinnaar is. Controleer altijd beide spelersregels per leg om geen finish te missen en om zeker te weten wie de leg won. Tel pas na controle van alle wedstrijden het totaal per speler en het toernooitotaal op. Bij onvolledige details moet je expliciet zeggen dat alleen de met zekerheid bevestigde 100+ finishes gerapporteerd kunnen worden.
```
